# jack-o — Claude Config

## Project Overview
**Type:** Other: Microcontroller/Animatronics
**Stack:** C++ (Arduino framework), PlatformIO, ESP8266/SAMD21
**Goal:** Animatronic singing pumpkin trio
...
## Trello
- Board: not configured — run /sync-trello to set up
